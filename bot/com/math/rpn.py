...
mat = {
    ...
    'arcsec': (lambda a: numpy.arccos(1 / a)),
    'arccsc': (lambda a: numpy.arcsin(1 / a)),
    'arccot': (lambda a: numpy.arctan(1 / a)),
    'arcsech': (lambda a: numpy.arccosh(1 / a)),
    'arccsch': (lambda a: numpy.arcsinh(1 / a)),
    'arccoth': (lambda a: numpy.arctanh(1 / a)),
